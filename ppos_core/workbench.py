...
def bootstrap_payload(conn: sqlite3.Connection) -> dict[str, Any]:
    ...
    return {
        ...
        "garmin_exports": list_garmin_exports(),
        "synthetic_import_approvals": list_synthetic_import_approvals(conn),
        ...
        "api_routes": [
            ...
            "GET /api/garmin-exports",
            "GET /api/manual-exports/{export_id}",
            "POST /api/manual-imports/approval",
            "GET /api/manual-imports/approvals",
            ...
            "POST /api/manual-imports/{session_id}/consume",
